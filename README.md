...
- With Git installed, simply type `git clone https://github.com/Pingpong403/NintenVil-Card-Generator` and press ENTER.
...
4) Run `NintenVil-Card-Generator.exe` to assemble the cards. They will be found in -Exports
...
I did not create the Nintendo Villainous (NintenVil) system.
